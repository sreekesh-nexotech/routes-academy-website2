...
const TestimonialVideo: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="w-screen min-h-[60vh] sm:h-[75vh] md:h-[80vh] lg:h-[85vh] bg-white flex flex-col items-center justify-start gap-4 sm:gap-6 md:gap-8 py-8 sm:py-10 md:py-12"
    >
      {/* Heading */}
