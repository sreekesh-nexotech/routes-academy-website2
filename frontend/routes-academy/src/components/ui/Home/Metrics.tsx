  ...
  return (
    <section className="w-[100vw] bg-[#F1F5F9] py-[10vh] px-[8vw] flex flex-col items-center gap-[6vh]">
      ...
      <div className="flex flex-col gap-[2.5vh] w-full">
        <h3 className="font-onest font-semibold text-[2.5rem] leading-[2.375rem] tracking-[0.03125em] text-center bg-gradient-to-b from-[#0A1E4A] to-[#104EFF] bg-clip-text text-transparent">
          Our results in numbers
        </h3>
        <h2 className="font-onest font-medium text-[1.6rem] leading-[1.75rem] text-[#404040] text-center">
      ...
      <div className="flex justify-center items-center flex-wrap gap-[10vw] w-full mt-[2vh]">
        {stats.map((stat, index) => {
          ...
          return (
            <div key={index} className="flex flex-col items-center gap-[3vh]">
              <p className="font-poppins font-semibold text-[4rem] leading-[3.625rem] tracking-[-0.0083em] text-[#1E293B] text-center">
                {numberPart}
                {operatorPart && (
              ...
              <p className="font-onest font-medium text-[1.5rem] leading-[1.875rem] tracking-[-0.0071em] text-[#1E293B] text-center">
                {stat.title}
              </p>
            </div>
          );
